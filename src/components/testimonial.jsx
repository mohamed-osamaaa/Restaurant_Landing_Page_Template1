...
function Testimonial() {
    return (
        <div id='testimonial' className='flex flex-col my-32 gap-20'>
            <div className='flex flex-col items-center text-center gap-9 w-1/3 mt-10 mx-auto'>
            ...
            <div className="flex flex-col items-center text-center bg-white p-2 px-5 gap-6 w-1/2 lg:w-1/3 mx-auto rounded-2xl">
